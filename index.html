...
<head>
    ...
    * {
    ...
    /* ========================================================= */
    /* === NUEVO CÓDIGO CSS AGREGADO PARA ALIENS ANIMADOS ====== */
    /* ========================================================= */
    ...
    @keyframes alienFlyDiagonal {
        0% { transform: translate(-10%, 110%); }
        100% { transform: translate(120%, -20%); }
    }

    .alien.diagonal {
        animation: alienFlyDiagonal 18s linear infinite;
    }

    @keyframes alienFlyHorizontal {
        0% { transform: translate(-20%, 30%); }
        100% { transform: translate(120%, 30%); }
    }

    .alien.horizontal {
        animation: alienFlyHorizontal 25s linear infinite;
    }

    @keyframes alienZigZag {
        0% { transform: translate(-10%, 70%) rotate(0deg); }
        50% { transform: translate(50%, 60%) rotate(10deg); }
        100% { transform: translate(120%, 80%) rotate(-10deg); }
    }

    .alien.zigzag {
        animation: alienZigZag 22s linear infinite;
    }
    </style>
</head>
...
<header class="header">
    ...
    <div class="header-content">
        ...
        <img src="TU_IMAGEN_AQUÍ.jpg" alt="Foto ficticia" style="width:180px; border-radius:15px; margin-top:20px; box-shadow:0 0 20px #00ffff;">
...
<section class="about">
    <h2>¿De qué trata?</h2>
    <p>
        Esta plataforma está diseñada para formar profesionales en Inteligencia Artificial, automatización 
        y tecnologías del futuro. Aprendé a dominar sistemas inteligentes, innovación tecnológica y 
        soluciones avanzadas que están transformando el mundo.
    </p>
</section>
